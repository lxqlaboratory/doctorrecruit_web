<template>
  ...
  <div class="prologin-container">
      ...
      <div class="login-box">
        <div class="input-form">
          <div style="width: 100%;">
            ...
            <div style="position: relative;width: 100%;margin-top: 30px;">
             ...
             <svg-icon icon-class="password" />
              ...
              <input v-model="loginForm.password"   type="password" class="login-form-input" style="width: 91%">
              <el-button
                type="text"
          ...
          <el-row style=" position: relative; margin-top: 15px; width: 100%">
            <el-col style="width: 40%" align="left">
              <el-input v-model="code"  maxlength="4" type="text" placeholder="请输入验证码" @keyup.enter.native="login" />
            </el-col>
          ...
          <div style="width: 100%;margin-top: 10px">
            <el-row>
              <el-col>
                <el-button  class="loginBtn" style="width: 100%;margin-bottom: 5%;background: #409EFF;color: white" :loading="loading" @click="handleLogin">登录</el-button>
              </el-col>
              <el-col>
                <el-button  class="loginBtn" style="width: 100%;background: #409EFF;color: white" :loading="loading" @click="reDirect">注册</el-button>
              </el-col>
            </el-row>
          </div>
    ...
    <div class="notice">
      ...
      <!--文字更换-->
      <div class="notice-title">临床博士招生管理系统</div>
